...
\title{SELENE: Scalable Evidence-Based Oracles Using\\
...
deployability.
We present SELENE (Ledger-grounded Uncertainty-aware Networked
...
This paper introduces \emph{SELENE} (Ledger-grounded
...
SELENE mitigates this by binding each posterior submission
...
\begin{figure}[t]
  ...
  {\fbox{\parbox{\columnwidth}{\centering\vspace{1.5cm}
   ...
   \vspace{1.5cm}}}}
  \caption{SELENE interaction protocol covering BN
...
We evaluate SELENE along four dimensions:
...
Table~\ref{tab:gas-comparison} compares SELENE's
...
\begin{table}[t]
\centering
\caption{Per-query gas: SELENE \texttt{submitInference}
...
At 4~evidence nodes, SELENE requires \placeholder{A}~gas
...
confirming that the gas advantage of SELENE's design
grows with BN size.
