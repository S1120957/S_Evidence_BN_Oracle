# SELENE: Scalable Evidence-Based Oracles Using Bayesian Networks

**Target journal:** IEEE Journal of Biomedical and Health Informatics (JBHI)

SELENE is a Bayesian network (BN)-based oracle architecture for blockchain
...
# Fixed-point fidelity â€” neutral CPTs
python posterior_fidelity_logs.py

# Fixed-point fidelity â€” asymmetric CPTs
...
SELENE uses a discrete Naive Bayes structure for physician-visit verification:

- **Root nodes:** PPH (in-person), PPR (remote) â€” marginally independent
...
- **Fixed-point encoding:** SCALE = 10^6, max rounding error = 5Ã—10^-7
...
MIT â€” see contract source files.
