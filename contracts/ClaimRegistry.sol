...
/// @title  ClaimRegistry
/// @notice Manages the lifecycle of SELENE claims and stores the latest
...
contract ClaimRegistry {
    ...
    ///         None      â€“ claim does not exist (mapping default).
    ///         Open      â€“ accepting posterior updates.
    ///         Finalized â€“ absorbing; no further writes accepted.
